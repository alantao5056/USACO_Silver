...
public class CowntagionFileInput {
  static int N;
  ...
  public static void main(String[] args) throws IOException{
    String in = new String(Files.readAllBytes(Paths.get("cowntagion.in")));
    st = new StringTokenizer(in);
    PrintWriter pw = new PrintWriter(new FileWriter("cowntagion.out"));
